...
Bingo.game = (function () {
	...
	*/
		makeBoard: function (numRows, numColumns, set) {
	...
	******************************************************************************/
	...
	startNewGame: function () {
		...
		Bingo.game.drawNumber();
		Bingo.game.repeatDraw();
	},
	
	repeatDraw: function () {
		draw = setInterval(function(){Bingo.game.drawNumber();},5000);
	},
	
	numPicks: 1,
	
	drawNumber: function () {
		if (Bingo.game.numPicks === squares.length) {	
			clearInterval(draw);
